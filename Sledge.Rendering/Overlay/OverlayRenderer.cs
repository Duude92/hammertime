...
namespace Sledge.Rendering.Overlay
{
	internal class ImGui2DRenderer : I2DRenderer, IDisposable
	{
		...
		private void BeginWindow()
		{
			...
			var vp = (_viewport as Avalonia.Controls.Control).Bounds;
			ImGui.SetNextWindowSizeConstraints(new Vector2((int)vp.Width, (int)vp.Height), new Vector2((int)vp.Width, (int)vp.Height));
