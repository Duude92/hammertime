...
namespace Sledge.Rendering.Engine
{
	...
	public class EngineInterface
	{
		...
		public GraphicsDevice Device => Engine.Instance.Device;

		/// <summary>
		/// Create a new viewport for the engine.
		/// </summary>
		/// <returns>The viewport</returns>
		public IViewport CreateViewport(bool mapViewport = true)
		{
			return mapViewport ? Engine.Instance.CreateViewport() : Engine.Instance.CreateViewportOnly();
		}
