...
{
	internal class SwapchainShadowOverlay : IPipeline
	{
		...
		public float Order => 2;
		private static VertexStandard[] _overlayVertices = new VertexStandard[]
		{
			new VertexStandard{ Position = new Vector3(0.5f, 0.5f, 0f), Texture = new Vector2(0, 1) },
			new VertexStandard{ Position = new Vector3( 1, 0.5f, 0f), Texture = new Vector2(1, 1) },
			new VertexStandard{ Position = new Vector3(0.5f,  1, 0f), Texture = new Vector2(0, 0) },
			new VertexStandard{ Position = new Vector3( 1,  1, 0f), Texture = new Vector2(1, 0) },
		};
		UInt32[] _quadIndices = { 0, 1, 2, 2, 1, 3 };
		private Resources.Texture _shadowTexture;

		public SwapchainShadowOverlay(Resources.Texture shadowTexture)
		{
		...
		{
			(_vertex, _fragment) = context.ResourceLoader.LoadShaders("SwapchainShadowOverlay");
