...
[AutoTranslate]
public partial class MapInformationDialog : Window, IDialog
{
	...
	//public string Title { set => this.InvokeLater(() => Title = value); }
	...
	public string CloseButton { set => this.InvokeLater(() => CloseDialogButton.Content = value); }
