...
public partial class VisgroupSidebarPanel : UserControl, ISidebarComponent, IInitialiseHook
{
	...
	public string EditButton { set { this.InvokeLater(() => { btnEdit.Content = value; }); } }
	public string SelectButton { set { this.InvokeLater(() => { btnSelect.Content = value; }); } }
	public string ShowAllButton { set { this.InvokeLater(() => { btnShowAll.Content = value; }); } }
	public string NewButton { set { this.InvokeLater(() => { btnNew.Content = value; }); } }
	...
	private void ShowAllButtonClicked(object sender, RoutedEventArgs e)
	{
